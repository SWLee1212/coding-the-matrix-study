...
def make_nine_equations(corners):
    ...
    '''
    return make_equations(corners[0][0], corners[0][1],0,0)+ make_equations(corners[1][0], corners[1][1],0,1)+ make_equations(corners[2][0], corners[2][1],1,0)+ make_equations(corners[3][0], corners[3][1],1,1)+[w]
